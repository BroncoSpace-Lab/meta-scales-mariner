...
Although this is the 1.0v Release, it is still unfinished as Fprime components, dependencies and other packages will be required for the core functionality of the purpose of the device, so this is just the first stable build for the carrier board and its necessary software to run the hardware.
